...
<form action="add_topics_handler.php" method="POST" enctype="multipart/form-data">
    ...
    <label for="learning_materials">Learning Materials (PDFs, Documents, Videos, etc.):</label>
    <input type="file" name="learning_materials[]" multiple>

    <button type="submit">Add Topic and Materials</button>
</form>
