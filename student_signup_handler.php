...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($email) || empty($password)) {
        die("All fields are required. <a href='student_signup.php'>Go back</a>");
    }

    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        die("Invalid email format. <a href='student_signup.php'>Go back</a>");
    }
    ...
    if ($stmt->fetch()) {
        die("Email already registered. <a href='student_signup.php'>Try again</a>");
    }
    ...
    if ($success) {
        ...
        echo "Signup failed. Please try again. <a href='student_signup.php'>Go Back </a> ";
    }
} else {
